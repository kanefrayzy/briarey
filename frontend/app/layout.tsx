...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Бриарей — узлы стыковочные, дымососы и системы газодымоудаления',
    template: '%s | Бриарей',
  },
  description:
    'Производство и продажа систем газодымоудаления: узлы стыковочные, дымососы ДПЭ, клапаны сброса давления. Отгрузка по всей России от производителя — ООО «Бриарей».',
  icons: {
    icon: [
  ...
  openGraph: {
    ...
    locale: 'ru_RU',
    siteName: 'Бриарей',
    title: 'Бриарей — узлы стыковочные, дымососы и системы газодымоудаления',
    description:
      'Производство и продажа систем газодымоудаления: узлы стыковочные, дымососы ДПЭ, клапаны сброса давления. Отгрузка по всей России от производителя.',
    url: SITE_URL,
  ...
  twitter: {
    ...
    title: 'Бриарей — узлы стыковочные, дымососы и системы газодымоудаления',
    description:
      'Производство и продажа систем газодымоудаления: узлы стыковочные, дымососы ДПЭ, клапаны сброса давления.',
  },
  alternates: {
    canonical: '/',
  },
