      ...
      <main>
        ...
        <section className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-14 pb-6">
          <p className="text-white/60 max-w-3xl leading-relaxed">
            Отгрузка и доставка осуществляются по рабочим дням с 9:00 до 17:00. Ниже — основные условия
            доставки оборудования. По любым вопросам логистики свяжитесь с нами — поможем выбрать оптимальный
            способ под ваш заказ.
          </p>
        </section>
        ...
        <section className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-14 pb-10">
          ...
          >
            ...
            <p className="text-white/65 text-sm leading-relaxed">
              Возможен со склада в г. Раменское (Московская область) по рабочим дням с 9:00 до 17:00.
