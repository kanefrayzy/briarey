...
const defaultSteps = [
  {
    num: '01',
    title: 'Знакомимся',
    desc: 'Расскажите о компании, регионе работы, клиентах и направлениях продаж.',
  },
  {
    num: '02',
    title: 'Получаем ваше предложение',
    desc: 'Предложите формат сотрудничества, планируемые объёмы и коммерческую модель, которая интересна вашей компании.',
  },
  {
    num: '03',
    title: 'Согласовываем партнёрство',
    desc: 'Обсуждаем условия, возможности производителя и формат технической поддержки.',
  },
]
