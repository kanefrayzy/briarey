...
const CardContent = () => (
  <>
    ...
    <h2 className="text-white text-2xl md:text-3xl font-medium leading-snug">
      Работа, в которой<br />всё понятно
    </h2>
    <p className="text-white/70 text-sm leading-relaxed">
      Официальное оформление, стабильная зарплата, нормированный рабочий день и команда, в которой помогают освоиться и стать профессионалом.
    </p>
  </>
)
